...
# first_user.photo.attach(io: File.open("app/assets/images/maria_gutierrez.jpg"), filename: first_user.last_name, content_type: "image/jpg")
# first_user.photo.attach(io: File.open("app/assets/images/maria_gutierrez_cv.jpg"), filename: first_user.last_name, content_type: "image/jpg")
###
